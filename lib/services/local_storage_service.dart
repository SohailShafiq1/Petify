  ...
  Future<void> _initializeDummyData() async {
    ...
    if (_petsBox.isEmpty) {
      final dummyPets = [
        ...
        // Pets owned by test user
        PetModel(
          id: 'my_pet_1',
          name: 'Labrador Max',
          category: 'Dogs',
          age: 2,
          description: 'Friendly Labrador, loves to play fetch. Very energetic and good with children.',
          price: 600.0,
          ownerName: 'Test User',
          ownerContact: '+1234567890',
          ownerId: 'test_user_1',
        ...
        PetModel(
          ...
          category: 'Cats',
          age: 3,
          description: 'Calm and affectionate British Shorthair. Perfect indoor cat.',
          price: 450.0,
          ownerName: 'Test User',
          ownerContact: '+1234567890',
          ownerId: 'test_user_1',
        ...
        PetModel(
          ...
          category: 'Dogs',
          age: 4,
          description: 'Sweet and gentle Beagle. Great family dog, loves kids.',
          price: 550.0,
          ownerName: 'Test User',
          ownerContact: '+1234567890',
          ownerId: 'test_user_1',
          createdAt: DateTime.now().subtract(const Duration(days: 20)),
          isAvailable: false, // Sold pet
        ),
        PetModel(
          id: 'my_pet_4',
          ...
          category: 'Birds',
          age: 1,
          description: 'Beautiful cockatiel, very friendly and loves attention.',
          price: 120.0,
          ownerName: 'Test User',
          ownerContact: '+1234567890',
          ownerId: 'test_user_1',
